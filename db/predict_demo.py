...
def main():
    ...
    parser.add_argument('--folder_image_path', type=str, help='folder image path')
    ...
    files, dirs = GetFiles(os.path.expanduser(args['folder_image_path']))
    for file in files:
        Demo(experiment, experiment_args, cmd=args).inference(file, args['visualize'])
